...
class ExtractStringComponent extends Component {
  constructor () {
    super()
...
ExtractStringComponent.propTypes = nodePropTypes
...
module.exports = {
  ...
  implementation: (state, inputs) =>
    String(path(strToPath(state.path), inputs.value)),
  component: ExtractStringComponent,
  state: {
    path: ''
  },
  inputs: {
